...
import { OrderedListServiceEmployeeInterface, useOrderedList } from '@/app/utils/hooks/admin/dragAndDrop/useOrderedList';
import {
                ...
                >
                    <div className={styles.magnifyingGlass}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M6.43844 1.00848C5.42349 1.15975 4.53098 1.49608 3.71989 2.03296C3.13496 2.42016 2.41605 3.1386 2.02921 3.72262C1.56702 4.42036 1.2613 5.14876 1.08304 5.97707C1.00823 6.32454 0.998922 6.46464 1.00009 7.22607C1.00126 7.97231 1.01192 8.13186 1.08231 8.45462C1.45071 10.1443 2.40071 11.5367 3.80988 12.4522C5.89254 13.8054 8.62066 13.7871 10.6851 12.4061L11.0253 12.1785L12.3829 13.5323C13.2936 14.4406 13.785 14.9048 13.8759 14.9428C14.0823 15.029 14.4084 15.0163 14.6013 14.9145C14.8424 14.7873 14.9745 14.5767 14.9927 14.2906C15.0195 13.8706 15.0499 13.9104 13.5474 12.4015L12.1779 11.0262L12.4054 10.6863C13.3472 9.2794 13.6808 7.48146 13.3047 5.83927C12.7535 3.43304 10.9085 1.62082 8.47109 1.09169C8.18768 1.03016 7.96254 1.01271 7.33289 1.00355C6.90118 0.997312 6.49868 0.999502 6.43844 1.00848ZM7.71622 2.59253C8.36573 2.66603 9.0159 2.88485 9.56483 3.21465C9.9628 3.45376 10.1798 3.62492 10.5178 3.96633C10.9041 4.3566 11.1349 4.68389 11.3882 5.20062C11.9143 6.27396 12.0017 7.46193 11.6402 8.62571C11.2038 10.0307 9.98434 11.233 8.5667 11.6559C8.00806 11.8226 7.85436 11.8427 7.1686 11.8394C6.55366 11.8364 6.48331 11.8288 6.07337 11.721C4.5431 11.3188 3.29607 10.1628 2.80734 8.69355C2.6263 8.14927 2.57672 7.84133 2.57402 7.24431C2.57135 6.65117 2.62494 6.2879 2.79036 5.77789C3.29786 4.21325 4.64916 3.00079 6.2559 2.66836C6.82871 2.54983 7.17849 2.53169 7.71622 2.59253Z" fill="#2F3035" stroke="#2F3035" strokeWidth="0.3" />
                        </svg>
                    </div>
                    <input
                        ...
                        {employees.map((employee, i) => {
                            ...
                            >
                                ...
                                >
                                    ...
                                    {employeesModalIsOpen[i] && <ModalWindow
                                        title="Ви дійсно бажаєте видалити цього лікаря?"
                                    >
                                        <button
                                            className={`btn cancel`}
                                            type='button'
                                            onClick={() => handleModalState(false, i)}
                                        >
                                            Скасувати видалення
                                        </button>
                                        <button
