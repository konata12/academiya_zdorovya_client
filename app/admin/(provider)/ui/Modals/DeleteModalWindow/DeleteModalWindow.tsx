...
import ModalWindow, { ModalWindowProps } from '@/app/admin/(provider)/ui/Modals/ModalWindow/ModalWindow'
    ...
    return (
        <ModalWindow title={title}>
            <button
                ...
                onClick={() => { closeModalHandler(index) }}
            >
                Скасувати видалення
            </button>
            {error.delete?.[index]?.message && <span
