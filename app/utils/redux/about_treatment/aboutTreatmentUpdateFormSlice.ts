import { AboutTreatment, AboutTreatmentEnum, AboutTreatmentFormData } from "@/app/types/data/about_treatment.type"
...
const aboutTreatmentUpdateFormSlice = createSlice({
    ...
    reducers: {
        ...
        setAllAboutTreatmentDataOnLink(state, action: { payload: AboutTreatment }) {
            ...
            state.errors = {
                title: { message: '' },
                treatmentTypes: Array(action.payload.treatmentTypes.length).fill({ message: '' }),
                image: { message: '' },
            }
        },
        ...
        setAboutTreatmentUpdateTreatmentType(state, action: {
        ...
        // SET ERRORS
        setAboutTreatmentUpdateBasicValueError(state, action: {
            payload: {
        ...
        setAboutTreatmentUpdateTreatmentTypesValueError(state, action: {
            payload: {
                index: number,
                message: string
            }
