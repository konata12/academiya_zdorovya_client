...
export function useAboutTreatmentFormSlice(indexedDBStoreName: AboutTreatmentFormIndexedDBType) {
        ...
        switch (indexedDBStoreName) {
            case "about_treatment_create_images":
                return {
                    ...
                    setTreatmentTypesValueError: setAboutTreatmentCreateTreatmentTypesValueError,
                };
            ...
            case "about_treatment_update_images":
                return {
                    ...
                    setTreatmentTypesValueError: setAboutTreatmentUpdateTreatmentTypesValueError,
                };
        }
    }, [indexedDBStoreName])
