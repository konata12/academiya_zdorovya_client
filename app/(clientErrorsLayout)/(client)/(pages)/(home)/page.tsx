...
import WhatWeTreatHomeLists from "@/app/(clientErrorsLayout)/(client)/ui/Home/WhatWeTreatHomeList/WhatWeTreatHomeLists";
import WhatWeTreatHomeListsFallback from "@/app/(clientErrorsLayout)/(client)/ui/Home/WhatWeTreatHomeList/fallback/WhatWeTreatHomeListsFallback";
import HowWeTreatArticles from "@/app/(clientErrorsLayout)/(client)/ui/Home/HowWeTreatArticles/HowWeTreatArticles";
import OurServicesList from "@/app/(clientErrorsLayout)/(client)/ui/Home/OurServicesList/OurServicesList";
import GoalsCards from "@/app/(clientErrorsLayout)/(client)/ui/Home/GoalsCards/GoalsCards";
import FAQList from "@/app/(clientErrorsLayout)/(client)/ui/Home/FAQList/FAQList";
import DepartmentPhoneNumberBtn from "@/app/(clientErrorsLayout)/(client)/ui/Home/DepartmentPhoneNumberBtn/DepartmentPhoneNumberBtn";
import DepartmentPhoneNumberBtnFallback from "@/app/(clientErrorsLayout)/(client)/ui/Home/DepartmentPhoneNumberBtn/DepartmentPhoneNumberBtnFallback";
